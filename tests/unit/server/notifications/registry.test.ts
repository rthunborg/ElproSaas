...
test("13.2 notification category registry derives the active essential follow-up category", () => {
  assert.deepEqual(activeNotificationCategories(), [{ category: "quote.follow_up_due", module: "quotes", defaultEnabled: true, essential: true }]);
