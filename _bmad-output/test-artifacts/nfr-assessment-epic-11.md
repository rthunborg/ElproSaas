...
| Monitoring | 99.5% monthly availability; server-error rate <1%; checks every five minutes; alert after three consecutive failures; retain 30 days of operational history. | A bounded three-failure alert notification was received. As of 2026-09-15T03:30Z, two scheduled runs were observed, so the five-minute cadence is not met; no 30-day observation or error-rate denominator exists. |
