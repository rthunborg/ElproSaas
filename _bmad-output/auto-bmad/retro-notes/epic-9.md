...
- [Phase 7 â€” Tier A review] Awareness-noted-but-not-fixed pattern: the 9.5 dev self-documented the dotted-ID reconciliation gap (inherited 9-4 awareness item) in comments yet shipped the guard weaker than AC3 â€” the dotted money/tax IDs are the highest-stakes blockers, exactly the families the no-drift guard skipped. Reviewers should treat self-documented gaps as fix candidates, not absolution.
