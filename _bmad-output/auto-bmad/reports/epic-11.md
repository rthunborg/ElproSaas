...
**Status:** The callback action is **in progress**, not closed. PR #62 is still draft with CI pending. Hosted Supabase Auth site URL, redirect allow-list, and templates still need dashboard inspection, and there is no hosted email-delivery proof. The retrospective remains rejected until the repair is published, verified, deployed, and those hosted facts are recorded.
