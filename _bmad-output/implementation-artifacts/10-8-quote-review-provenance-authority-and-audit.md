...
- Accepted and fixed the reset-recovery false-green: complete table/function/trigger evidence is mandatory, with 906/906 full integration/RLS tests and 1,675/1,675 unit tests green locally.
