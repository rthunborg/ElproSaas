...
- Accepted the underlying PDF-width finding with a corrected reproduction: the three cited summary rows fit at valid limits, while the adjacent standard-VAT category row overflowed. General width-aware wrapping fixes both that case and future long customer-visible rows; 1,675/1,675 unit tests and the visual margin check are green.
