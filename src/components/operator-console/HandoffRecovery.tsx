...
export function HandoffRecovery({ tenantId, requiresReconciliation, canRetry }: { readonly tenantId: string; readonly requiresReconciliation: boolean; readonly canRetry: boolean }) {
