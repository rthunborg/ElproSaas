...
export const SCOPE_MANIFEST: ScopeManifest = {
  modules: [
    ...
    },
    {
      ...
      navItems: [],
      tenantTables: ["job_runs", "notifications", "notification_preferences", "email_outbox", "email_delivery_events", "email_suppressions", "email_unsubscribe_tokens", "email_unsubscribe_rate_limits", "email_delivery_artifacts", "email_delivery_recoveries"],
      widgets: [],
